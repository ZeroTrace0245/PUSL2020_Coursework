            ...
            try
            {
                ...
                if (result.Succeeded)
                {
                    try
                    {
                        ...
                        string role = (model.UserType == "Supervisor") ? "Supervisor" : "Student";
                        ...
                        else if (model.UserType == "Supervisor")
                        {
                            ...
                            _context.SupervisorProfiles.Add(supervisorProfile);
                        }
                    ...
                    catch (Exception ex)
                    {
                        ...
                        ModelState.AddModelError(string.Empty, "Error creating user profile: " + ex.Message);
                        return View(model);
                    }
                }
                    ...
                    if (signedInUser != null)
                    {
                        ...
                        if (string.IsNullOrWhiteSpace(model.ReturnUrl))
                        {
                            ...
                            if (roles.Contains("Student"))
                                return RedirectToAction("Index", "StudentProjects");
                        }
                    }
